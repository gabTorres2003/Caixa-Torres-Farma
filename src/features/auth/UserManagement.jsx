...
export const UserManagement = () => {
  ...
  const onCadastrarUsuario = async (data) => {
    ...
    try {
      // 1. Criar o usuário no microsserviço de autenticação do Supabase (Auth)
          ...
          <Card title="Adicionar Novo Operador" icon={UserPlus}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <FormInput
                ...
                register={register('email', { required: 'O e-mail é obrigatório' })}
                error={errors.email}
              />
              ...
              <FormInput
                ...
                register={register('password', { 
                  ...
                  minLength: { value: 6, message: 'A senha deve ter pelo menos 6 dígitos' }
                })}
              ...
              <Button type="submit" isLoading={isActionLoading}>Criar Conta do Operador</Button>
            </div>
          </Card>
        </form>
